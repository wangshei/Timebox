...
By accessing or using The Timeboxing Club ("the Service"), operated at timeboxing.club, you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.

## 2. Description of Service

The Timeboxing Club is a web-based calendar and task management application that helps you plan your time using the timeboxing method. The Service allows you to:

- Create and manage tasks with time estimates
- Schedule time blocks on a calendar (planned and recorded)
...
**You own your data.** All calendar events, tasks, time blocks, notes, and other content you create belong to you. We do not claim ownership of your content.

By using the Service, you grant us a limited license to store, process, and display your content solely to provide and improve the Service. This license ends when you delete your content or your account.
